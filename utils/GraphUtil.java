...
public class GraphUtil {
    ...
    private static void printIntMap(Map<Node, Integer> map, Graph graph) {
        for (Node n : graph.getNodeSet()) {
            if (map.get(n) == null) {
    ...
    public static void printSeen(Map<Node, Integer> map, Graph graph) {
        System.out.print("Seen: \t\t");
        printIntMap(map, graph);
    }

    public static void printDone(Map<Node, Integer> map, Graph graph) {
